...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="gdm jpeg new-login offensive opengl pam +perl -pwent selinux suid xinerama"
...
src_prepare() {
	...
	eapply \
		...
		"${FILESDIR}"/${PN}-5.34-allow-normal-auth-disable.patch
